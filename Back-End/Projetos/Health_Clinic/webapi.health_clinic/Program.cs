...
builder.Services.AddControllers().AddJsonOptions(options => options.JsonSerializerOptions.Converters.Add(new Converter()));
...
builder.Services.AddAuthentication(options =>
{
    ...
    .AddJwtBearer("JwtBearer", options =>
    {
        options.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            ValidIssuer = "webapi.health",

            //nome do audience (para onde está vindo)
            ValidAudience = "webapi.health"
        };
    });
